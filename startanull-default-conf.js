...
/**
 * Startanull Config constructor
 * @param {String} srcDir (Sources directory)
 * @param {String} resDir (Result directory)
 * @return {Object} (Startanull Config)
 */
module.exports = (
  srcDir = path.resolve(__dirname, 'src'),
  resDir = path.resolve(__dirname, 'assets')
) => {
  let conf = {};
